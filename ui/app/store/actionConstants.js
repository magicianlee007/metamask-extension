...
// anonymous mode
export const SWITCH_ON_PROXY_MODE = 'SWITCH_ON_PROXY_MODE';
export const SWITCH_OFF_PROXY_MODE = 'SWITCH_OFF_PROXY_MODE';

export const __METAMONK_SWITCH_METAMONK_MODE =
  '__METAMONK_SWITCH_METAMONK_MODE';

export const __METAMONK_ADD_IDENTITY = '__METAMONK_ADD_IDENTITY';

export const __METAMONK_SET_SELECTED_IDENTITY =
  '__METAMONK_SET_SELECTED_IDENTITY';

export const __METAMONK_SET_PENDING_IDENTITIES =
  '__METAMONK_SET_PENDING_IDENTITIES';
export const __METAMONK_CLEAR_PENDING_IDENTITIES = 'CLEAR_PENDING_IDENTITIES';

export const __METAMONK_UPDATE_PROXY_CONTRACTS =
  '__METAMONK_UPDATE_PROXY_CONTRACTS';
